...
function populateMaps (extensions, types) {
  ...
  Object.keys(MIME_TYPES).forEach(function (type) {
    ...
    for (let i = 0; i < exts.length; i++) {
      ...
      if (types[extension]) {
        const start = preference.indexOf(MIME_TYPES[types[extension]].source)
        const end = preference.indexOf(mime.source)
        // TODO brad please check this if statement, I had to update it for an eslint error
